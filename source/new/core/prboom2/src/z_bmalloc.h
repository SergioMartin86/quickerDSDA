...
#define DECLARE_BLOCK_MEMORY_ALLOC_ZONE(name) extern __STORAGE_MODIFIER struct block_memory_alloc_s name
#define IMPLEMENT_BLOCK_MEMORY_ALLOC_ZONE(name, size, num, desc) \
__STORAGE_MODIFIER struct block_memory_alloc_s name = { NULL, size, num, desc}
