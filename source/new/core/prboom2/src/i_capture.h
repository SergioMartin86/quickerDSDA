...
extern __STORAGE_MODIFIER int cap_fps;
extern __STORAGE_MODIFIER int cap_frac;
extern __STORAGE_MODIFIER int cap_wipescreen;

// true if we're capturing video
extern __STORAGE_MODIFIER int capturing_video;
