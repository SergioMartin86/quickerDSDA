...
static __STORAGE_MODIFIER int quickstart_cache_tics;
static __STORAGE_MODIFIER int quickstart_queued;
static signed __STORAGE_MODIFIER short angleturn_cache[35];
static unsigned __STORAGE_MODIFIER int angleturn_cache_index;
