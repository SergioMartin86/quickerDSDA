...
__STORAGE_MODIFIER dboolean dsda_100k_note_shown = false;
__STORAGE_MODIFIER dboolean dsda_pacifist_note_shown = false;
__STORAGE_MODIFIER dboolean dsda_reality_note_shown = false;
__STORAGE_MODIFIER dboolean dsda_almost_reality_note_shown = false;
